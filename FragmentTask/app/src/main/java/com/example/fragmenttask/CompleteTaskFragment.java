...
public class CompleteTaskFragment extends Fragment {
    ...
    TextView compliteListText;
    public CompleteTaskFragment(ArrayList<String> tasks) {
    ...
    public static CompleteTaskFragment newInstance(String param1, String param2) {
        CompleteTaskFragment fragment = new CompleteTaskFragment(new ArrayList<>());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        compliteListText = v.findViewById(R.id.complete_list_task);
        for (int i = 0; i < tasks.size(); i++) {
            compliteListText.append(tasks.get(i) + "\n");
        }
        return v;
    }
}