...
public class CurrentTaskFragment extends Fragment {
    ...
    EditText taskText, regularTask;
    Button writeButton;
    TextView taskListText;
    ArrayList<String> tasks;
    ArrayList<String> regularTasks;

    public CurrentTaskFragment(ArrayList<String> tasks, ArrayList<String> regularTasks) {
    ...
    public static CurrentTaskFragment newInstance(String param1, String param2) {
        CurrentTaskFragment fragment = new CurrentTaskFragment(new ArrayList<>(),new ArrayList<>());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        regularTask = v.findViewById(R.id.regular_task);
        ...
        writeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                regularTasks.add(regularTask.getText().toString());
                taskListText.append(regularTask.getText() + "\n");
            }
        });
